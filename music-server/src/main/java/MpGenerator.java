...
//    final static String dirPath = "";
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/tp_music?serverTimezone=Asia/Shanghai&useSSL=false");
...
//        pc.setXml("../resources/mapperXml");
        ...
        InjectionConfig cfg = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                map.put("Xianglu Peng", this.getConfig().getGlobalConfig().getAuthor() + "的模板生成完成！");
                this.setMap(map);
            }
        };
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return "../resources/mapper/"
                        // dirPath + "/mybatisplus/src/main/resources/mapper/"
...
/*        TemplateConfig tc = new TemplateConfig();
        ...
        // 打印注入设置【可无】
        System.err.println(mpg.getCfg().getMap().get("Xianglu Peng"));
    }
