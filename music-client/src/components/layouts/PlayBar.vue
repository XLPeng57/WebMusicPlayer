<template>
  <div class="play-bar" :class="{ show: !toggle }">
    <div class="fold" :class="{ turn: toggle }">
      <PIcon :icon="iconList.ZHEDIE" @click="toggle = !toggle"></PIcon>
    </div>
    <!--播放进度-->
    ...
    <div class="control-box">
      ...
      <div class="song-ctr">
        <PIcon class="yin-play-show" :icon="playStateList[playStateIndex]" @click="changePlayState"></PIcon>
        <!--上一首-->
        <PIcon class="yin-play-show" :icon="iconList.SHANGYISHOU" @click="prev"></PIcon>
        <!--播放-->
        <PIcon :icon="playBtnIcon" @click="togglePlay"></PIcon>
        <!--下一首-->
        <PIcon class="yin-play-show" :icon="iconList.XIAYISHOU" @click="next"></PIcon>
        <!--音量-->
        <el-dropdown class="yin-play-show" trigger="click">
          <PIcon v-if="volume !== 0" :icon="iconList.YINLIANG"></PIcon>
          <PIcon v-else :icon="iconList.JINGYIN"></PIcon>
          <template #dropdown>
            <el-dropdown-menu>
      ...
      <div class="song-ctr song-edit">
        ...
        ></PIcon>
        <!--歌曲列表-->
        <PIcon :icon="iconList.LIEBIAO" @click="changeAside"></PIcon>
      </div>
    </div>
  </div>
</template>
