<template>
  <div class="header">
    ...
    <div class="header-logo" @click="goPage()">
      <PIcon :icon="iconList.ERJI"></PIcon>
      <span>{{ musicName }}</span>
    </div>
    <HeaderNav class="header-nav" :styleList="headerNavList" :activeName="activeNavName" @click="goPage"></HeaderNav>
    <!--搜索框-->
    <div class="header-search">
      <el-input placeholder="搜索" :prefix-icon="Search" v-model="keywords" @keyup.enter="goSearch()" />
    </div>
    <!--设置-->
    <HeaderNav v-if="!token" :styleList="signList" :activeName="activeNavName" @click="goPage"></HeaderNav>
