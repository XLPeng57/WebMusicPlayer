<template>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const BOFANG = ref(Icon.PLAY);
      const ZANTING = ref(Icon.PAUSE);
      ...
      async function saveEdit() {
        ...
        const result = (await HttpManager.updateSongInfo({id,singerId,name,introduction,lyric})) as ResponseBody;
        (proxy as any).$message({
