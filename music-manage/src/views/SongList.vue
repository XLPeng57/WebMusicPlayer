  ...
  export default defineComponent({
    ...
    setup() {
      ...
      async function addsongList() {
        ...
        const result = (await HttpManager.addSongList({title, introduction, style})) as ResponseBody;
        (proxy as any).$message({
      ...
      async function saveEdit() {
        ...
        const result = (await HttpManager.updateSongListInfo({id, title, introduction, style})) as ResponseBody;
        (proxy as any).$message({
          message: result.message,
          type: result.type,
        });
